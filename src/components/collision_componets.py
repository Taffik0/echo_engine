...
class CircleCollisionComponent(Component):
    def __init__(self, owner, radius, group, mask, active=True, touchable=False, *args, **kwargs):
        super().__init__(**kwargs)
        self.circle_collider = CircleCollider(owner, radius, group, mask, active=active, touchable=touchable)
